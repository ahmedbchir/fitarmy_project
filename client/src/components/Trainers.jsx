  ...
  return (
    <div>
      ...
      <div key="{trainer.id}">
        ...
        {<strong>trainer.name</strong>} is a Certified Strength and Condition
        Specialist (CSCS) with the National Strength and Conditioning
        Association. {"trainer.gender" === "male" ? "He" : "She"} has an extensive
        background from training professional and amateur athletes to working
        professionals with nominal experience in fitness.
